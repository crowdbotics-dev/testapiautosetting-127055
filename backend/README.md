...
## Project Structure
    ...
    ├── testapiautosetting_127055  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127055`
...
2. Clone this repo and `cd testapiautosetting_127055`
